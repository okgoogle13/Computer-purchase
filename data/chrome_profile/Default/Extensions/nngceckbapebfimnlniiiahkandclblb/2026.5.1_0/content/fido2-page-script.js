...
class WebauthnUtils {
    ...
    static mapCredentialRequestOptions(options, fallbackSupported) {
        ...
        return {
            allowedCredentialIds: (_b = (_a = keyOptions.allowCredentials) === null || _a === void 0 ? void 0 : _a.map((c) => Fido2Utils.arrayToString(Fido2Utils.bufferSourceToUint8Array(c.id)))) !== null && _b !== void 0 ? _b : [],
            challenge: Fido2Utils.arrayToString(Fido2Utils.bufferSourceToUint8Array(keyOptions.challenge)),
